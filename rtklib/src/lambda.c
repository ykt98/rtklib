...
/*整数高斯变换 integer gauss transformation ----------------------------------------------*/
...
*          int    m      I  固定解决方案数量 number of fixed solutions
*          double *a     I  float parameters (n x 1)
*          double *Q     I 浮点参数的协方差矩阵 covariance matrix of float parameters (n x n)
*          double *F     O 固定解决方案  fixed solutions (n x m)
